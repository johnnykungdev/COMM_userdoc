**what we want to accomplish by today: get the instructions down in a rough draft** 

**we will meet up on Tuesday the 13th at 5pm for final touch-ups and to convert to markdown**

5 sets of instructions:

1. Create a project - done 
2. inviting someone to collab with [https://help.figma.com/hc/en-us/sections/360006780134-Collaboration](https://help.figma.com/hc/en-us/sections/360006780134-Collaboration)  - done 
3. design - layer properties (building web structure with layer)
4. building components (includes using frame, shapes, text etc.)
5. plugin (we need to choose one plugin to integrate)
6. Save a copy/save to version history 

Styles in Figma [https://help.figma.com/hc/en-us/articles/360039238753-Styles-in-Figma](https://help.figma.com/hc/en-us/articles/360039238753-Styles-in-Figma) 

Introduction questions: 100 words for the intro paragraph for the user docs.

- format for the intro page [https://amirashvins.github.io/how-to-use-CLion/](https://amirashvins.github.io/how-to-use-CLion/)

Who is the intended user?

- Beginners who want to learn how to navigate Figma.
...
- Free version of Figma (web app and desktop app) and any browser 
(we're using web version)
- computer
- email account

What are the procedures

- state pricing plans (3 plans), and we'll use the starter plan (with screenshots)
...
In this documentation, we will be using the web version of Figma with a free starter plan. Once you sign up with an email account, you'll get access to up to 3 projects and be able to collaborate with another editor online.
...
commands & actions: paste, open, save etc.

(for screenshots, we better make same width or same height)
...
4. Teams can set different permissions for a project: 
    ...
    ![https://s3-us-west-2.amazonaws.com/secure.notion-static.com/8e1f140b-5daa-452d-b5e7-1d1f37a819b0/Screen_Shot_2021-03-31_at_12.55.12_PM.png](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/8e1f140b-5daa-452d-b5e7-1d1f37a819b0/Screen_Shot_2021-03-31_at_12.55.12_PM.png)
...
1. Choose a team project to invite someone to in the sidebar and go to the Members tab.
    ...
    ![https://s3-us-west-2.amazonaws.com/secure.notion-static.com/e86302d7-1d76-47bb-8ef3-4f331b55fa8e/Screen_Shot_2021-04-07_at_10.51.06_AM.png](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/e86302d7-1d76-47bb-8ef3-4f331b55fa8e/Screen_Shot_2021-04-07_at_10.51.06_AM.png)
...
3. A pop-up will appear for the email for the new member. There will be an option between can view or can edit. Click on the drop-down menu and choose can view. Figma will send the invite to the email. 
    ...
    ![https://s3-us-west-2.amazonaws.com/secure.notion-static.com/2f5c4ad1-59c0-473a-93e3-0d205605461b/Screen_Shot_2021-04-07_at_11.04.25_AM.png](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/2f5c4ad1-59c0-473a-93e3-0d205605461b/Screen_Shot_2021-04-07_at_11.04.25_AM.png)
...
3. A pop-up will appear for the email for the new member. There will be an option between can view or can edit. Click on the drop-down menu and choose can edit. Figma will send the invite to the email. 
    ...
    ![https://s3-us-west-2.amazonaws.com/secure.notion-static.com/d7b010e9-3f73-4ed3-a123-283a21ef1145/Screen_Shot_2021-04-07_at_11.34.41_AM.png](https://s3-us-west-2.amazonaws.com/secure.notion-static.com/d7b010e9-3f73-4ed3-a123-283a21ef1145/Screen_Shot_2021-04-07_at_11.34.41_AM.png)
...
[https://help.figma.com/hc/en-us/articles/360039831974-View-layers-and-assets-in-the-Layers-Panel](https://help.figma.com/hc/en-us/articles/360039831974-View-layers-and-assets-in-the-Layers-Panel)
...
*user prototyping tool to add interactions among the pages 

## Save the work

this will contain content of saving the work as a local copy or save it to the version history.
